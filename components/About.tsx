  ...
  return (
    <div className="container px-2 md:px-4 mx-auto py-7 md:py-12 space-y-5">
      ...
      <p className=" first-letter:pl-6 text-lg md:text-3xl">
        ...
        odrzavaju tokom celog dana i osmisljeni su tako da odgovaraju svakoj
        starosnoj dobi.Kvalitet treninga ogleda se u prilagodjavanju intenziteta
        treninga svakoj grupi kao i pojedincu. Polaznici uvek dobijaju treninge
        razlicite dinamike i sadrzine. Zahvaljujuci novoj lokaciji, blizu
        trolejbuskih i autobuskih stanica, ulica sa parkingom, klub je lako
        dostupan polaznicima iz razlicitih delova grada. Ono po cemu se ovaj
        klub razlikuje od drugih je maksimalni komfor i privatnost članova, kao
        i visok kvalitet treninga, kao i manje grupe za rad. U ponudi su
      ...
      <p className=" first-letter:pl-6 text-lg md:text-3xl">
        ...
        našeg organizma. Sem estetskog, nedostatak treninga dovodi i do niza
